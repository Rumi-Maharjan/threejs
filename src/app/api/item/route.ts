...
export async function PATCH(req:Request) {
    ...
    const size = sizesString.length > 0 ? stringArrayToEnum(Sizes, sizesString) : undefined;
    const color = colorsString.length > 0 ? stringArrayToEnum(Color, colorsString) : undefined;
